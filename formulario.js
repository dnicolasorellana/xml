...
function obtenerDatos() {
    ...
    var a = document.querySelectorAll(".unAlumno");

    console.log("-----------------------------------------------------");
    console.log(a);

    for (let i = 0; i<a.length ; i++){
        var aux = a[i].children;
...
function addAsig() {
    ...
    var a_cre = document.createElement("creditos"); a_cre.innerHTML = asig[3];
    ...
    var a_nom = as.createElement("profesores");
